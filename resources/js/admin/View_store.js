...
// import Css
import "../assets/admin/css/Store.css";
...
function View_store() {
  ...
  function showlist(){
    axios.get('api/view_store').then(res=>{
  ...
  function project_delete(id){
    axios.delete('api/delete_store/'+id).then((res)=>{
  ...
  function disable_project(id){
   axios.post('api/disable_store/'+id).then((res)=>{
 ...
 function enable_project(id){
    axios.post('api/enable_store/'+id).then((res)=>{
      if(res.data.status === 200){
        swal('success',res.data.message,'success');
        showlist();
            ...
            <div className='col-12 paddingR'>
                ...
                <div className='row'>
                    <div className='col-12'>
                        ...
                        <Link to='/admin/add_store'><AddBoxIcon className='PlusIcon StorePlusIcon' /></Link>
                        </div>
                    </div>
                </div>
